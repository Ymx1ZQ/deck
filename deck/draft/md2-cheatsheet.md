...
Compact reference for the [md2](https://github.com/guidance-studio/md2) markdown-to-presentation syntax. Everything the draft stage needs without fetching md2's full README.
