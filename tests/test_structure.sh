...
assert_file "deck/SKILL.md"
assert_file "deck/brief/prompt.md"
assert_file "deck/draft/prompt.md"
assert_file "deck/draft/slide-patterns.md"
assert_file "deck/draft/copy-rules.md"
assert_file "deck/draft/md2-cheatsheet.md"
